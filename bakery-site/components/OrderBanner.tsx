...
export default function OrderBanner() {
  return (
    <section className="py-24 px-6 bg-pink-600 text-white text-center">
      <p className="section-label text-pink-200 mb-4">Ready to get started?</p>
      ...
      <Link
        href="/order"
        className="inline-block bg-white text-pink-600 px-10 py-4 rounded-full text-sm tracking-widest uppercase font-medium hover:bg-blush transition-colors duration-200"
      >
        Start Your Order
      </Link>
    </section>

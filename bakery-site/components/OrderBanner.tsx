    ...
    <section className="py-24 px-6 relative overflow-hidden bg-pink-600">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <Link
            href="/order"
            className="inline-block bg-white text-pink-600 px-10 py-4 rounded-full text-sm tracking-widest uppercase font-bold hover:bg-pink-50 transition-colors duration-200"
          >
            Start Your Order
          </Link>
          <a
            ...
            className="inline-block border-2 border-white/50 text-white px-10 py-4 rounded-full text-sm tracking-widest uppercase font-semibold hover:bg-white/10 transition-colors duration-200"
          >
            DM on Instagram
          </a>
        </div>

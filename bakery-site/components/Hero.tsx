    ...
    <section className="pt-16 relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Colorful sweets and pastries"
          fill
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 md:px-16 py-24 w-full">
        <div className="max-w-xl">
          {/* Badge */}
          <span className="inline-block bg-pink-500/20 border border-pink-400/40 text-pink-200 text-xs tracking-[0.2em] uppercase px-4 py-1.5 rounded-full mb-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="#menu"
              className="inline-block border-2 border-white/60 text-white px-8 py-3 rounded-full text-sm tracking-widest uppercase font-semibold hover:bg-white/10 transition-colors duration-200"
            >
              See the Menu
            </Link>
          </div>
          ...
          <div className="flex gap-8 mt-14 pt-8 border-t border-white/20">
            {[
              { number: "500+", label: "Cakes delivered" },
